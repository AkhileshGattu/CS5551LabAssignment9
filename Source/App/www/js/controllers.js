...
.controller('LoginCtrl', function($scope, $state, $http, $window, $httpParamSerializerJQLike) {
    ...
    $scope.home = function() {
        ...
        $scope.login = function(username, password) {
            ...
            $http({
                    method: 'GET',
                    url: 'https://api.mongolab.com/api/1/databases/ase_spring/collections//Lab8?apiKey=fLr-gBAV6_SS8Qtf-0-MEBlfR51d2nQr',
...
.controller('ProfileCtrl', function($scope, $state, $http, $window, $httpParamSerializerJQLike) {
    ...
    $scope.home = function() {
        ...
        $scope.delete = function() {
            ...
            $http({
                method: 'DELETE',
                url: 'https://api.mongolab.com/api/1/databases/ase_spring/collections//Lab8/' + id + '?apiKey=fLr-gBAV6_SS8Qtf-0-MEBlfR51d2nQr',
   ...
   $scope.pageClass = 'home';
    ...
    $scope.facebookLogin = function() {
        $cordovaOauth.facebook("796495870456506", ["email"]).then(function(result) {
            $state.go('home');
        }, function(error) {
            // error
        });
